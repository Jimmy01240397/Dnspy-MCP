...
public static class LiveDebugTools
{
    ...
    public static object AgentList(AgentRegistry reg) => ToolGuard.Run(() =>
    {
        ...
        return (object)reg.All.Select(kv => new {
            name = kv.Key,
            host = kv.Value.Host,
            port = kv.Value.Port,
    ...
    public static object AgentListMethods(AgentRegistry reg, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("__list__")!);
    ...
    public static object SessionInfo(AgentRegistry reg, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("session.info")!);
    ...
    public static object Go(AgentRegistry reg, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("session.go")!);
    ...
    public static object Pause(AgentRegistry reg, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("session.pause")!);
    ...
    public static object Terminate(AgentRegistry reg, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("session.terminate")!);
    ...
    public static object WaitPaused(AgentRegistry reg, int timeoutMs = 5000, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("debug.wait_paused", new { timeoutMs })!);

    // ---- threads / stack ------------------------------------------------

    [McpServerTool(Name = "live_thread_list")]
    [Description("[LIVE] List managed threads in the target process.")]
    public static object ThreadList(AgentRegistry reg, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("thread.list")!);
    ...
    public static object ThreadStack(AgentRegistry reg, int threadId, int max = 32, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("thread.stack", new { threadId, max })!);
    ...
    public static object CurrentThread(AgentRegistry reg, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("thread.current")!);

    // ---- modules --------------------------------------------------------

    [McpServerTool(Name = "live_list_modules")]
    [Description("[LIVE] List managed modules currently loaded in the attached process.")]
    public static object ListModules(AgentRegistry reg, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("module.list_live")!);
    ...
    public static object FindType(AgentRegistry reg, string typeFullName, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("module.find_type_live", new { typeFullName })!);
    ...
    public static object ListTypeMethods(AgentRegistry reg, string modulePath, string typeFullName, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("module.list_type_methods", new { modulePath, typeFullName })!);
    ...
    public static object BpSetIl(AgentRegistry reg, string modulePath, uint token, uint offset = 0, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("bp.set_il", new { modulePath, token, offset })!);
    ...
    public static object BpSetByName(AgentRegistry reg, string modulePath, string typeFullName, string methodName, int overloadIndex = 0, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("bp.set_by_name", new { modulePath, typeFullName, methodName, overloadIndex })!);

    [McpServerTool(Name = "live_bp_list")]
    [Description("[LIVE] List all breakpoints currently registered on the agent.")]
    public static object BpList(AgentRegistry reg, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("bp.list")!);
    ...
    public static object BpDelete(AgentRegistry reg, int id, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("bp.delete", new { id })!);
    ...
    public static object BpEnable(AgentRegistry reg, int id, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("bp.enable", new { id })!);
    ...
    public static object BpDisable(AgentRegistry reg, int id, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("bp.disable", new { id })!);
    ...
    public static object StepIn(AgentRegistry reg, int timeoutMs = 5000, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("step.in", new { timeoutMs })!);
    ...
    public static object StepOver(AgentRegistry reg, int timeoutMs = 5000, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("step.over", new { timeoutMs })!);
    ...
    public static object StepOut(AgentRegistry reg, int timeoutMs = 5000, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("step.out", new { timeoutMs })!);
    ...
    public static object HeapFind(AgentRegistry reg, string typeName, int max = 256, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("heap.find_instances", new { typeName, max })!);
    ...
    public static object HeapReadObject(AgentRegistry reg, ulong address, int maxFields = 64, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("heap.read_object", new { address, maxFields })!);
    ...
    public static object HeapReadString(AgentRegistry reg, ulong address, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("heap.read_string", new { address })!);
    ...
    public static object HeapStats(AgentRegistry reg, int top = 25, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("heap.stats", new { top })!);
    ...
    public static object MemoryRead(AgentRegistry reg, ulong address, int size, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("memory.read", new { address, size })!);
    ...
    public static object MemoryWrite(AgentRegistry reg, ulong address, string hex, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("memory.write", new { address, hex })!);
    ...
    public static object MemoryReadInt(AgentRegistry reg, ulong address, string kind = "i32", string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("memory.read_int", new { address, kind })!);
    ...
    public static object Disasm(AgentRegistry reg, ulong address, int size = 128, string? agent = null)
        => ToolGuard.Run(() => (object)reg.Get(agent).Result("memory.disasm", new { address, size })!);
}
